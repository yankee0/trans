        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="row">
              ...
              <div class="col-md d-grid">
                <button class="btn btn-warning d-flex align-items-center justify-content-center gap-2" data-bs-toggle="modal" data-bs-target="#livInf"><i data-feather="truck"></i>Livraison</button>
              </div>
              <div class="col-md d-grid">
